		...
		sections: [
			{
				...
				body:
					"Des fragments récupérés d'un registre logistique de la République mentionnent Montréal comme une ville désignée pour mener des essais civiques à long terme. Le programme Berger semble avoir introduit une nouvelle arme expérimentale non enregistrée. À la suite de cela, des observations ont été menées sur le comportement public, l'obéissance institutionnelle et la dérive administrative. L'acheminement de cette expérience porte à croire qu'il y aurait un complexe souterrain dirigé et en activité. Ce qui subsiste de ce manifeste évoque des salles d'admission, d'observations, des purges périodiques ainsi que des transferts sortants marqués pour la ville inférieure de la République. Les dernières annotations semblent avoir été corrompues. Cela dit, elles parlent de main-d'oeuvre docile et de contentement. Rien n'indique si Montréal était au courant qu'elle faisait l'objet d'un test.",
			},
		],
	},
	"zone-10": {
